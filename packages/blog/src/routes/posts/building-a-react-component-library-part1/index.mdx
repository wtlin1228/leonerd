...
excerpt: Discussing the foundations of a UI library, selecting the right style engine, leveraging the styled system, and establishing a dynamic theme color palette.
date: 2023-02-22
tags: [react, ui-library, color-mode]
featured: /posts/building-a-react-component-library-part1/cover.webp
---
