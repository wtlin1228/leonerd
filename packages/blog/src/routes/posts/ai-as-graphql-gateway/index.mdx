...
excerpt: The Apollo federation architecture had been adopted by thousands of companies. Let's learn it with an interesting example "What if Pokemons attend StarWars?"
date: 2023-07-01
