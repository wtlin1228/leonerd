...
excerpt: Discover how adopting the Docs-like-Code approach can tackle documentation challenges in expanding organizations, promoting seamless collaboration and reducing the cost of maintaining high-quality documentation.
date: 2023-04-05
tags: [docs-like-code, backstage, internal-tool]
featured: /posts/scaling-documentation-with-a-growing-team-backstage-and-docs-like-code/cover.webp
---

import { Image } from '../../../components/image/image.tsx';

# Scaling Documentation with a Growing Team - Backstage and Docs-like-Code
...
<Image
  imgSrc="/posts/scaling-documentation-with-a-growing-team-backstage-and-docs-like-code/software-catalog-home.webp"
  imgAlt="backstage catalog home page"
/>

Here is an example landing page:

<Image
  imgSrc="/posts/scaling-documentation-with-a-growing-team-backstage-and-docs-like-code/software-catalog-landing-page.webp"
  imgAlt="backstage catalog landing page"
/>
...
<Image
  imgSrc="/posts/scaling-documentation-with-a-growing-team-backstage-and-docs-like-code/software-model-entities.svg"
  imgAlt="backstage software modal entities"
...
<Image
  imgSrc="/posts/scaling-documentation-with-a-growing-team-backstage-and-docs-like-code/software-templates.webp"
  imgAlt="backstage templates"
/>
...
<Image
  imgSrc="/posts/scaling-documentation-with-a-growing-team-backstage-and-docs-like-code/backstage-search.webp"
  imgAlt="backstage search"
/>
...
<Image
  imgSrc="/posts/scaling-documentation-with-a-growing-team-backstage-and-docs-like-code/backstage-techdocs.webp"
  imgAlt="backstage techdocs"
/>
